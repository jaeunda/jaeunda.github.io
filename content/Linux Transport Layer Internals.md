...
Whereas a **transport-layer protocol** provides logical communication between **processes** running on different hosts, a **network-layer protocol** provides logical communication between **hosts.** - _Computer Networking, A Top Down Approach, 7th ed._
